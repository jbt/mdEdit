var h,m=function(){function a(a,b){e[a]=d[a]=c[a]=b}function b(a,b){e[a]=c[a]=b}var c={p:Prism.l.m.p},d={},e={},f={m:["markup","html","xml"],H:["javascript","js"]},g;for(g in Prism.l)if(Prism.l.hasOwnProperty(g)){var k=Prism.l[g];if("function"!==typeof k){var l=f[g];b("code-block fenced "+g,{pattern:new RegExp("(^ {0,3}|\\n {0,3})(([`~])\\3\\3) *("+(l?l.join("|"):g)+")( [^`\n]*)? *\\n(?:[\\s\\S]*?)\\n {0,3}(\\2\\3*(?= *\\n)|$)","gi"),b:!0,a:{"code-language":{pattern:/(^([`~])\2+)((?!\2)[^\2\n])+/,
b:!0},"marker code-fence start":/^([`~])\1+/,"marker code-fence end":/([`~])\1+$/,"code-inner":{pattern:/(^\n)[\s\S]*(?=\n$)/,b:!0,C:"language-"+g,a:k}}})}}b("code-block fenced",{pattern:/(^ {0,3}|\n {0,3})(([`~])\3\3)[^`\n]*\n(?:[\s\S]*?)\n {0,3}(\2\3*(?= *\n)|$)/g,b:!0,a:{"code-language":{pattern:/(^([`~])\2+)((?!\2)[^\2\n])+/,b:!0},"marker code-fence start":/^([`~])\1+/,"marker code-fence end":/([`~])\1+$/,"code-inner":{pattern:/(^\n)[\s\S]*(?=\n$)/,b:!0}}});b("heading setext-heading heading-1",
{pattern:/^ {0,3}[^\s].*\n {0,3}=+[ \t]*$/gm,a:{"marker heading-setext-line":{pattern:/^( {0,3}[^\s].*\n) {0,3}=+[ \t]*$/gm,b:!0},n:d}});b("heading setext-heading heading-2",{pattern:/^ {0,3}[^\s].*\n {0,3}-+[ \t]*$/gm,a:{"marker heading-setext-line":{pattern:/^( {0,3}[^\s].*\n) {0,3}-+[ \t]*$/gm,b:!0},n:d}});f={"marker heading-hash start":/^ *#+ */,"marker heading-hash end":/ +#+ *$/,n:d};for(g=1;6>=g;g+=1)b("heading heading-"+g,{pattern:new RegExp("^ {0,3}#{"+g+"}(?!#).*$","gm"),a:f});g={pattern:/^\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]/,
a:{"marker bracket start":/^\[/,"marker bracket end":/\]$/,"link-text-inner":{pattern:/[\w\W]+/,a:d}}};var f={pattern:/\[(?:\\.|[^\]])*\]/,a:{"marker bracket start":/^\[/,"marker bracket end":/\]$/,"link-label-inner":/[\w\W]+/}},k={pattern:/^!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]/,a:{"marker image-bang":/^!/,"marker bracket start":/^\[/,"marker bracket end":/\]$/,"image-text-inner":{pattern:/[\w\W]+/,a:d}}},l={pattern:/^(\s*)(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))+/,b:!0},v={pattern:/^(\s*)<(?:\\.|[^<>\n])*>/,
b:!0,a:{"marker brace start":/^</,"marker brace end":/>$/,"braced-href-inner":/[\w\W]+/}},w={pattern:/('(?:\\'|[^'])+'|"(?:\\"|[^"])+")\s*$/,a:{"marker quote start":/^['"]/,"marker quote end":/['"]$/,"title-inner":/[\w\W]+/}},x={pattern:/\( *(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)( +('(?:[^']|\\')+'|"(?:[^"]|\\")+"))? *\)/,a:{"marker bracket start":/^\(/,"marker bracket end":/\)$/,"link-params-inner":{pattern:/[\w\W]+/,a:{"link-title":w,href:l,"braced-href":v}}}};b("hr",{pattern:/^[\t ]*([*\-_])([\t ]*\1){2,}([\t ]*$)/gm,
a:{"marker hr-marker":/[*\-_]/g}});b("urldef",{pattern:/^( {0,3})\[(?:\\.|[^\]])+]: *\n? *(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)( *\n? *('(?:\\'|[^'])+'|"(?:\\"|[^"])+"))?$/gm,b:!0,a:{"link-label":f,"marker urldef-colon":/^:/,"link-title":w,href:l,"braced-href":v}});b("blockquote",{pattern:/^[\t ]*>[\t ]?.+(?:\n(?!\n)|.)*/gm,a:{"marker quote-marker":/^[\t ]*>[\t ]?/gm,"blockquote-content":{pattern:/[^>]+/,n:e}}});b("list",{pattern:/^[\t ]*([*+\-]|\d+\.)[\t ].+(?:\n(?!\n)|.)*/gm,
a:{I:{pattern:/^[\t ]*([*+\-]|\d+\.)[\t ].+(?:\n|[ \t]+[^*+\- \t].*\n)*/gm,a:{"marker list-item":/^[ \t]*([*+\-]|\d+\.)[ \t]/m,n:e}}}});b("code-block",{pattern:/(^|(?:^|(?:^|\n)(?![ \t]*([*+\-]|\d+\.)[ \t]).*\n)\s*?\n)((?: {4}|\t).*(?:\n|$))+/g,b:!0});b("p",{pattern:/[^\n](?:\n(?!\n)|.)*[^\n]/g,a:d});a("image",{pattern:/(^|[^\\])!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]\(\s*(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)(\s+('(?:[^']|\\')+'|"(?:[^"]|\\")+"))?\s*\)/,b:!0,a:{"link-text":k,"link-params":x}});
a("link",{pattern:/(^|[^\\])\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]\(\s*(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)(\s+('(?:[^']|\\')+'|"(?:[^"]|\\")+"))?\s*\)/,b:!0,a:{"link-text":g,"link-params":x}});a("image image-ref",{pattern:/(^|[^\\])!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\] ?\[(?:\\.|[^\]])*\]/,b:!0,a:{"link-text":k,"link-label":f}});a("link link-ref",{pattern:/(^|[^\\])\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\] ?\[(?:\\.|[^\]])*\]/,b:!0,a:{"link-text":g,"link-label":f}});a("image image-ref shortcut-ref",
{pattern:/(^|[^\\])!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]/,b:!0,a:{"marker image-bang":/^!/,"link-text":g}});a("link link-ref shortcut-ref",{pattern:/(^|[^\\])\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]/,b:!0,a:{"link-text":g}});a("code",{pattern:/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/g,b:!0,a:{"marker code-marker start":/^`/,"marker code-marker end":/`$/,"code-inner":/[\w\W]+/}});a("strong",{pattern:/(^|[^\\*_]|\\[*_])([_\*])\2(?:\n(?!\n)|.)+?\2{2}(?!\2)/g,b:!0,a:{"marker strong-marker start":/^(\*\*|__)/,"marker strong-marker end":/(\*\*|__)$/,
"strong-inner":{pattern:/[\w\W]+/,a:d}}});a("em",{pattern:/(^|[^\\*_]|\\[*_])(\*|_)(?:\n(?!\n)|.)+?\2(?!\2)/g,b:!0,a:{"marker em-marker start":/^(\*|_)/,"marker em-marker end":/(\*|_)$/,"em-inner":{pattern:/[\w\W]+/,a:d}}});a("strike",{pattern:/(^|\n|(?!\\)\W)(~~)(?=\S)([^\r]*?\S)\2/gm,b:!0,a:{"marker strike-marker start":/^~~/,"marker strike-marker end":/~~$/,"strike-inner":{pattern:/[\w\W]+/,a:d}}});a("comment",Prism.l.m.p);a("tag",Prism.l.m.tag);a("entity",Prism.l.m.D);return c}(),n={J:function(a){var b=
a.start,c=a.e.slice(a.e.lastIndexOf("\n")+1),d=c.match(/^\s*/)[0],e="";/^ {0,3}$/.test(d)&&(c=c.slice(d.length),/^[*+\-]\s+/.test(c)?e+=c.match(/^[*+\-]\s+/)[0]:/^\d+\.\s+/.test(c)?e+=c.match(/^\d+\.\s+/)[0].replace(/^\d+/,function(a){return+a+1}):/^>/.test(c)&&(e+=c.match(/^>\s*/)[0]));d+=e;a.e+="\n"+d;e=a.g;a.g="";a.start+=1+d.length;a.end=a.start;return{add:"\n"+d,d:e,start:b}},G:function(a,b){var c=a.e.lastIndexOf("\n")+1;if(b.inverse)/\s/.test(a.e.charAt(c))&&(a.e=a.e.splice(c,1),--a.start),
...
function t(a,b,c){var d=document.createRange(),e=u(a.h,b),f=e;c&&c!==b&&(f=u(a.h,c));y.call(a,f.element,f.offset);d.setStart(e.element,e.offset);d.setEnd(f.element,f.offset);a=getSelection();a.removeAllRanges();a.addRange(d)}var z=document.createElement("span");z.style.position="absolute";z.innerHTML="|";
function y(a,b){var c=a.textContent,d=a.parentNode,e=c.slice(0,b);a.textContent=c.slice(b);e=document.createTextNode(e);d.insertBefore(z,a);d.insertBefore(e,z);var f=z.offsetTop,g=z.offsetHeight,k=this.h.offsetHeight,l=this.h.scrollTop;a.textContent=c;d.removeChild(z);d.removeChild(e);0>f-l?this.h.scrollTop=f:f-l+g>k&&(this.h.scrollTop=f+g-k)}
function u(a,b){if(!a)return null;var c=0,d=a;do{var e=d;if(d=d.firstChild){do{var f=d.textContent.length;if(c<=b&&c+f>b)break;c+=f}while(d=d.nextSibling)}if(!d)break}while(d&&d.hasChildNodes()&&3!=d.nodeType);if(d)return{element:d,offset:b-c};if(e){for(d=e;d&&d.lastChild;)d=d.lastChild;return 3===d.nodeType?{element:d,offset:d.textContent.length}:{element:d,offset:0}}return{element:a,offset:0,error:!0}}function A(a){this.r=a;this.j=[];this.o=[]}
...
h.u=function(a){var b=a.metaKey||a.ctrlKey;switch(a.keyCode){case 8:case 46:var b=q(this.c),c=r(this.c),d=b===c?1:Math.abs(c-b),b=8===a.keyCode?c-d:b;this.i.action({add:"",d:this.f.textContent.slice(b,b+d),start:b});break;case 9:b||(this.action("indent",{inverse:a.shiftKey}),a.preventDefault());break;case 219:case 221:b&&!a.shiftKey&&(this.action("indent",{inverse:219===a.keyCode,q:!0}),a.preventDefault());break;case 13:this.action("newline");a.preventDefault();break;case 89:b=this.i;b.o.length&&
