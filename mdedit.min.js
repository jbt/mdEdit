var h,m=function(){function a(a,b){e[a]=d[a]=c[a]=b}function b(a,b){e[a]=c[a]=b}var c={p:Prism.l.m.p},d={},e={},g={m:["markup","html","xml"],H:["javascript","js"]},f;for(f in Prism.l)if(Prism.l.hasOwnProperty(f)){var k=Prism.l[f];if("function"!==typeof k){var l=g[f];b("code-block fenced "+f,{pattern:new RegExp("(^ {0,3}|\\n {0,3})(([`~])\\3\\3) *("+(l?l.join("|"):f)+")( [^`\n]*)? *\\n(?:[\\s\\S]*?)\\n {0,3}(\\2\\3*(?= *\\n)|$)","gi"),b:!0,a:{"code-language":{pattern:/(^([`~])\2+)((?!\2)[^\2\n])+/,
b:!0},"marker code-fence start":/^([`~])\1+/,"marker code-fence end":/([`~])\1+$/,"code-inner":{pattern:/(^\n)[\s\S]*(?=\n$)/,b:!0,C:"language-"+f,a:k}}})}}b("code-block fenced untagged",{pattern:/(^ {0,3}|\n {0,3})(([`~])\3\3)[^`\n]*\n(?:[\s\S]*?)\n {0,3}(\2\3*(?= *\n)|$)/g,b:!0,a:{"code-language":{pattern:/(^([`~])\2+)((?!\2)[^\2\n])+/,b:!0},"marker code-fence start":/^([`~])\1+/,"marker code-fence end":/([`~])\1+$/,"code-inner":{pattern:/(^\n)[\s\S]*(?=\n$)/,b:!0}}});b("heading setext-heading heading-1",
...
a:{"marker bracket start":/^\[/,"marker bracket end":/\]$/,"link-text-inner":{pattern:/[\w\W]+/,a:d}}};var g={pattern:/\[(?:\\.|[^\]])*\]/,a:{"marker bracket start":/^\[/,"marker bracket end":/\]$/,"link-label-inner":/[\w\W]+/}},k={pattern:/^!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]/,a:{"marker image-bang":/^!/,"marker bracket start":/^\[/,"marker bracket end":/\]$/,"image-text-inner":{pattern:/[\w\W]+/,a:d}}},l={pattern:/^(\s*)(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))+/,b:!0},v={pattern:/^(\s*)<(?:\\.|[^<>\n])*>/,
...
a:{"marker hr-marker":/[*\-_]/g}});b("urldef",{pattern:/^( {0,3})\[(?:\\.|[^\]])+]: *\n? *(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)( *\n? *('(?:\\'|[^'])+'|"(?:\\"|[^"])+"))?$/gm,b:!0,a:{"link-label":g,"marker urldef-colon":/^:/,"link-title":w,href:l,"braced-href":v}});b("blockquote",{pattern:/^[\t ]*>[\t ]?.+(?:\n(?!\n)|.)*/gm,a:{"marker quote-marker":/^[\t ]*>[\t ]?/gm,"blockquote-content":{pattern:/[^>]+/,n:e}}});b("list",{pattern:/^[\t ]*([*+\-]|\d+\.)[\t ].+(?:\n(?!\n)|.)*/gm,
a:{I:{pattern:/^[\t ]*([*+\-]|\d+\.)[\t ].+(?:\n|[ \t]+[^*+\- \t].*\n)*/gm,a:{"marker list-item":/^[ \t]*([*+\-]|\d+\.)[ \t]/m,n:e}}}});b("code-block",{pattern:/(^|(?:^|(?:^|\n)(?![ \t]*([*+\-]|\d+\.)[ \t]).*\n)\s*?\n)((?: {4}|\t).*(?:\n|$))+/g,b:!0});b("p",{pattern:/[^\n](?:\n(?!\n)|.)*[^\n]/g,a:d});a("image",{pattern:/(^|[^\\])!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]\(\s*(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)(\s+('(?:[^']|\\')+'|"(?:[^"]|\\")+"))?\s*\)/,b:!0,a:{"link-text":k,"link-params":x}});
a("link",{pattern:/(^|[^\\])\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\]\(\s*(?:(?!<)(?:\\.|[^\(\)\s]|\([^\(\)\s]*\))*|<(?:[^<>\n]|\\.)*>)(\s+('(?:[^']|\\')+'|"(?:[^"]|\\")+"))?\s*\)/,b:!0,a:{"link-text":f,"link-params":x}});a("image image-ref",{pattern:/(^|[^\\])!\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\] ?\[(?:\\.|[^\]])*\]/,b:!0,a:{"link-text":k,"link-label":g}});a("link link-ref",{pattern:/(^|[^\\])\[(?:\\.|[^\[\]]|\[[^\[\]]*\])*\] ?\[(?:\\.|[^\]])*\]/,b:!0,a:{"link-text":f,"link-label":g}});a("image image-ref shortcut-ref",
...
function t(a,b,c){var d=document.createRange(),e=u(a.h,b),g=e;c&&c!==b&&(g=u(a.h,c));y.call(a,g.element,g.offset);d.setStart(e.element,e.offset);d.setEnd(g.element,g.offset);a=getSelection();a.removeAllRanges();a.addRange(d)}var z=document.createElement("span");z.style.position="absolute";z.innerHTML="|";
function y(a,b){var c=a.textContent,d=a.parentNode,e=c.slice(0,b);a.textContent=c.slice(b);e=document.createTextNode(e);d.insertBefore(z,a);d.insertBefore(e,z);var g=z.offsetTop,f=z.offsetHeight,k=this.h.offsetHeight,l=this.h.scrollTop;a.textContent=c;d.removeChild(z);d.removeChild(e);0>g-l?this.h.scrollTop=g:g-l+f>k&&(this.h.scrollTop=g+f-k)}
